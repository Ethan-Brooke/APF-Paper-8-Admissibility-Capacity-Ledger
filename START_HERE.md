...
You are reading the companion to **Paper 8** (this repo: https://github.com/Ethan-Brooke/APF-Paper-8-Admissibility-Capacity-Ledger). The canonical computational engine lives at codebase **v6.9** ([Zenodo](https://doi.org/10.5281/zenodo.18529115)). Each paper has its own companion repo following the same layout.
